...
<!-- Hero Section -->
<section class="min-h-[70vh] flex flex-col items-center justify-center text-center px-6 py-20 bg-white">
...
<!-- Donasi Programs Section -->
<section id="donasi" class="py-16 bg-gray-50 px-6">
    <div class="container mx-auto">
        <h2 class="text-3xl font-bold text-center text-gray-800 mb-2">Program Donasi</h2>
        <p class="text-center text-gray-500 mb-10">Pilih program yang ingin Anda dukung</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm p-6 hover:shadow-md transition-shadow">
                ...
                <div class="mb-3">
                    <div class="flex justify-between text-sm text-gray-600 mb-1">
                        <span>Terkumpul: Rp 8.200.000</span>
                        <span>55%</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
            ...
            <div class="bg-white rounded-2xl shadow-sm p-6 hover:shadow-md transition-shadow">
                ...
                <div class="mb-3">
                    <div class="flex justify-between text-sm text-gray-600 mb-1">
                        <span>Terkumpul: Rp 5.700.000</span>
                        <span>38%</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
...
<section class="py-16 bg-white px-6">
    <div class="container mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
                <p class="text-4xl font-bold text-green-600 mb-1">1.200+</p>
                <p class="text-gray-500 font-medium">Donatur Aktif</p>
            </div>
            <div>
                <p class="text-4xl font-bold text-green-600 mb-1">Rp 250 Jt+</p>
                <p class="text-gray-500 font-medium">Dana Terkumpul</p>
            </div>
            <div>
                <p class="text-4xl font-bold text-green-600 mb-1">350+</p>
                <p class="text-gray-500 font-medium">Penerima Manfaat</p>
            </div>
        </div>
    </div>
</section>
